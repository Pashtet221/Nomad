...
{
    const string privateCode = "DVIbsMDiOE2h0aeEIkrA1A7NvjHeoDH0OW3uenaEglCw";  //Key to Upload New Info
    const string publicCode = "64ee063c8f40bb0ee068dfbe";   //Key to download
